...
* Mensajes homogéneos
  ...
  * Backend: uniformar textos y códigos (400/404/409) en todas las rutas.
...
* Backend
  ...
  * Revisar errores uniformes: BAD\_REQUEST, NOT\_FOUND, CONFLICT.
...
* Android (emulador)
  ...
  * Geo/Cámara (inicio): permisos y captura; miniatura visible.
