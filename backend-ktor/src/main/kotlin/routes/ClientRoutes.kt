        ...
        authenticate {
            route("/api/v1/clients") {
                ...
                post {
                    ...
                    if (body.name.isBlank()) return@post call.respond(HttpStatusCode.BadRequest, ResponseEnvelope<Unit>(null, "BAD_REQUEST", "Client name required"))
                ...
                put("/{id}") {
                    ...
                    val body = call.receive<Client>()
                    if (body.name.isBlank()) return@put call.respond(HttpStatusCode.BadRequest, ResponseEnvelope<Unit>(null, "BAD_REQUEST", "Client name required"))
